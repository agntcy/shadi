...
## [0.2.1](https://github.com/agntcy/shadi/compare/agntcy-shadi-agent-secrets-v0.2.0...agntcy-shadi-agent-secrets-v0.2.1) - 2026-08-21

### Added

- *(desktop)* frictionless SSH onboarding, no env vars required ([#143](https://github.com/agntcy/shadi/pull/143))

## [0.2.0](https://github.com/agntcy/shadi/compare/agntcy-shadi-agent-secrets-v0.1.1...agntcy-shadi-agent-secrets-v0.2.0) - 2026-07-27

### Added

- *(identity)* DID identity & admission building blocks for SLIM v2 ([#94](https://github.com/agntcy/shadi/pull/94))

## [0.1.1](https://github.com/agntcy/shadi/compare/agntcy-shadi-agent-secrets-v0.1.0...agntcy-shadi-agent-secrets-v0.1.1) - 2026-04-20

### Other

- update Rust dependency versions ([#79](https://github.com/agntcy/shadi/pull/79))

## [0.1.0](https://github.com/agntcy/shadi/releases/tag/agntcy-shadi-agent-secrets-v0.1.0) - 2026-04-07
